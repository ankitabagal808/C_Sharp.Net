    ...
    public partial class frm_Update_Student_Details : Form
    {
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            if (tb_RollNo.Text != "")
            {
                ...
                Cmd.Connection = Con;
                Cmd.CommandText = "Select * from Students_Information Where RollNo = @RNo";
        ...
        private void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            if (tb_Name.Text != "" && tb_MobileNo.Text != "" && cmb_Course.Text != "")
            {
                ...
                Cmd.Connection = Con; ;
                Cmd.CommandText = "Update Students_Information Set Name= @Nm, Mobileno =@MNo,DOB=@DOB,Course = @Course Where RollNo =2RNo";
